...
For the pinned GLM W4A16 checkpoint, the adapter also binds every linear role to
its declared `compressed-tensors` encoding: INT4 group-128 for quantized
linears and BF16/FP32 for sensitive tensors. Packed I32 storage never overrides
those logical semantics.
