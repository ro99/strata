...
| F8-1 | Prove exact QPN8-derived FP8 primitive | E4M3/E8M0 block-128 fragment prepack and direct W8A16 register feed; independent decoder/matrix/boundary gates; no widened persistent path | **IN PROGRESS on owner-authorized Ampere-native persistent/fused successor (experiment 0145); experiment 0144's per-projection rejection stands** | A full compact W8A16 kernel now exists. Valid `wq_b+indexer.wq_b` fusion reaches 84.98% of the ruler; profile is 85.01% DRAM. Layer-resident scheduling and real-fixture/no-worse numerical closure remain open |
