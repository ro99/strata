#!/usr/bin/env bash
# Interleaved Gemma 4 first-page executor A/B at the locked production point.
set -euo pipefail

repo_root=$(cd "$(dirname "${BASH_SOURCE[0]}")/.." && pwd)
outdir=${1:-"${repo_root}/results/gemma4-device-page-ab"}
binary=${BINARY:-"${repo_root}/build-release/strata-gemma4-run"}
model=${MODEL:-"${repo_root}/models/gemma4"}
repetitions=${REPETITIONS:-3}
max_new=${MAX_NEW:-1}
prompt='one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one one '
...
run_arm() {
    ...
    /usr/bin/time -v "${binary}" \
        ...
        --max-context 512 --max-new "${max_new}" --prompt "${prompt}" \
