...
result_dir=${RESULT_DIR:-"${repo_root}/results/deepseek-v4-woa-lookup-ab"}
candidate=${CANDIDATE_BINARY:-"${repo_root}/build/strata-deepseek-run"}
reference=${REFERENCE_BINARY:-"/tmp/strata-dsv4-woa-lookup-baseline/build/strata-deepseek-run"}
