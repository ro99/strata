 ...
 *
 * Modified by Strata in 2026 to preserve FP32 result publication for its
 * BF16/MXFP4 specialization. See this directory's README for provenance and
 * the exact local modification commits.
 *
